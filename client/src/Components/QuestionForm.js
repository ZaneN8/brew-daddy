...
const addQuestion = async () => {
  try {
    let res = await axios.post(`/api/coffee_shops/${questionsShopId}/questions`, question);
...
try{
  debugger
  let res = await axios.put(`/api/coffee_shops/${questionsShopId}/questions/${questionProp}`, question)
  setQuestion(res.data)
}catch(err){
  debugger
